    ...
    return (
        ...
        <SidebarContainer>
            ...
            <SidebarOption>
                    ...
                    <span><Link to='MyDrive'>My Drive</Link></span>
                </SidebarOption>
                <SidebarOption>
                    <DevicesIcon />
                    <span><Link to='Computers'>Computers</Link></span>
                </SidebarOption>
                <SidebarOption>
                    <PeopleAltOutlinedIcon />
                    <span><Link to='SharedFile '>Shared With Me</Link></span>
                    
                </SidebarOption>
                <SidebarOption>
                    <QueryBuilderOutlinedIcon />
                    <span><Link to='Recent'>Recent</Link></span>
                </SidebarOption>
                <SidebarOption>
